...
export default function Index() {
  return (
    <>
      ...
      <img className = "left-1/2 -translate-x-1/2 absolute w-1/4 md:w-1/8 bottom-0 z-0" src = "https://hc-cdn.hel1.your-objectstorage.com/s/v3/e8ec60289f5ad98c6e15a24b3998e644944b755e_fire_sparks.gif"/>
