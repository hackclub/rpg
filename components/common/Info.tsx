...
export function Info({className}: {className?: string}){
    ...
    return (
        <>
        <div className = {`${className} flex gap-3 sm:gap-5 bg-darker/65 border border-black/75 rounded-lg p-2`}>
            ...
            { session.status === "authenticated" ? 
                <button onClick={() => setLogIsOpen(true)}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-scroll-text size-5"><path d="M15 12h-5"/><path d="M15 8h-5"/><path d="M19 17V5a2 2 0 0 0-2-2H4"/><path d="M8 21h12a2 2 0 0 0 2-2v-1a1 1 0 0 0-1-1H11a1 1 0 0 0-1 1v1a2 2 0 1 1-4 0V5a2 2 0 1 0-4 0v2a1 1 0 0 0 1 1h3"/></svg>
                </button> : null }
        ...
        <Modal isOpen={helpIsOpen} setIsOpen={setHelpIsOpen}>
            <h1 className = "text-3xl md:text-5xl py-4">Help</h1>
            <p>Descriptive help text explaining how to start sessions and what is a valid scrap goes here.</p>
        </Modal>
        </>
        : null }
